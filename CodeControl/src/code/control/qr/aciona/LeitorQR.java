...
public class LeitorQR extends JFrame implements Runnable, ThreadFactory {
    ...
    private Sistema notificador;

    public LeitorQR(Sistema notificador) {
        super();
    ...
    public void run() {
        ...
        do {
            ...
            if (result != null) {
                ...
                notificador.setTextoCriptografado(result.getText());
